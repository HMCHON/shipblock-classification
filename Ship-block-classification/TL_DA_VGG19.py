...
HEIGHT = 224
WIDTH = 224
base_model = VGG19(include_top = False, weights='imagenet', input_shape=(HEIGHT, WIDTH, 3))
#######################################################################
import os

#######################################################################
train_data_dir = "/home/user/PycharmProjects/lecture/Boundary_Project/imageset/new_original_2/500by300/50by300_train_test/train"
test_data_dir = "/home/user/PycharmProjects/lecture/Boundary_Project/imageset/new_original_2/500by300/50by300_train_test/test"
BATCH_SIZE = 64
...
#######################################################################
NUM_EPOCH = 10
num_train_images = 5184
num_test_images = 1296
######################################################################
...
skeras.save_history_history('TL_DA_VGG19', history.history, fold = foldname)

score = finetune_model.evaluate(validation_generator, verbose = 0)
finetune_model.save(os.path.join(foldname, 'TL_DA_VGG19.hdf5'))
print('Output results are saved in', foldname)

hist_df = pd.DataFrame(history.history)

hist_json_file = 'TL_DA_VGG19.json' 
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# or save to csv: 
hist_csv_file = 'TL_DA_VGG19.csv'
